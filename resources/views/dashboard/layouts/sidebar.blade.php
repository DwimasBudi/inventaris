      ...
      <div class="offcanvas-lg offcanvas-end bg-body-tertiary vh-100" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="navbar-nav flex-column mx-3">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 {{ Request::is('dashboard/items*') ? 'active' : '' }}" href="/dashboard/items">
                 <i class="bi bi-file-post"></i> Data Barang
              </a>
            </li>
          </ul>
        @can('admin')
        ...
        <ul class="navbar-nav flex-column mx-3">
            <li class="nav-item">
              <a class="nav-link {{ Request::is('dashboard/categories*') ? 'active' : '' }}" href="/dashboard/pinjam">
                <i class="bi bi-tags"></i> Barang di pinjam
              </a>
            </li>
            <li class="nav-item">
